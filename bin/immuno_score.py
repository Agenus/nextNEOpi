...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--pvacseq_tsv", required=False, help="Input filtered MHC I pVACseq TSV file"
    )
    parser.add_argument(
        "--score_tsv", required=False, help="Input immunogenicity scores TSV files"
    )
