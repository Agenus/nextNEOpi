...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="Parse the output files of pVACseq for all MHC I epitopes"
    )
    parser.add_argument(
        "--pvacseq_out", required=True, help="output file produced by pvacseq"
    )
    parser.add_argument(
        "--output", required=True, help="output file produced by tis script"
    )
